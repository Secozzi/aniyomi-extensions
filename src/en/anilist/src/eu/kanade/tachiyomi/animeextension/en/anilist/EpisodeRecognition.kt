...
object EpisodeRecognition {
     ...
     */
    private val UNWANTED = Regex("""(?:\b|_)(?:v|ver|vol|version|volume|season|s)[^a-z]?[0-9]+""")

    /**
     * Regex used to remove unwanted whitespace
     * Example One Piece 12 special -R> One Piece 12special
     */
    private val UNWANTED_WHITE_SPACE = Regex("""\s(?=extra|special|omake)""")
